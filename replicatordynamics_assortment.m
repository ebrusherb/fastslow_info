function [T,Y] = replicatordynamics_assortment(x,tmax,b,c,R,po,rhoinfo,pr,s,ps,rhoint)

[T,Y]=ode45(@replicatorgradient,[0 tmax],x);

function grad = replicatorgradient(t,x)
